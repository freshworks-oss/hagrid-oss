...
In this part of the documentation, we are going to understand the concepts of `Hagrid` which are mandatory to develop 
any connector
 
Hagrid has four main concepts named 
...
**Note:** : So when you can coming to create a connector then think how your DAG might looks like. Some connector DAG has just one API

...
public class MockFacadeAbstractJoinService implements MockFacadeInterface {
    ...
    public MockFacadeAbstractJoinService getAssetWithFreshJoin(@SuppressWarnings("unchecked") List<Optional<AbstractAsset>>... getAssetWithFreshJoin){
    ...
    public MockFacadeAbstractJoinService unwrappedBeanToClassMap(@SuppressWarnings("unchecked") HashMap<String, AbstractBean>... unwrappedBeanToClassMap) {

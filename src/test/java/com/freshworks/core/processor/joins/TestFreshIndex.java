...
import com.freshworks.core.data.four_zero_zero.unit.processor.joins.assets.FbUserUsageAssetFreshIndex;
...
public class TestFreshIndex {
    ...
    public void testFreshIndexSerializerWhenIndexKeyIsPresent() throws Exception{
        ...
        FbUserUsageAssetFreshIndex fbUserUsageAssetFreshIndex = new FbUserUsageAssetFreshIndex();
        fbUserUsageAssetFreshIndex.setUserId("user_id_12345");
        fbUserUsageAssetFreshIndex.setFirstName("amit");
        fbUserUsageAssetFreshIndex.setLastName("aggarwal");
        fbUserUsageAssetFreshIndex.setCreatedAt("20-02-2026");

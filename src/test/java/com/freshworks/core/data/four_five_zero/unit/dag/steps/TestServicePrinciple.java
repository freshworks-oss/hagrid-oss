package com.freshworks.core.data.four_zero_zero.unit.dag.steps;
...
@Slf4j
@FreshHierarchy(parentClass = TestApplication.class, rateLimit = 800, duration = 1)
@Component
@Scope("prototype")
@Conditional(CustomRegExConditionComparator.class)
public class TestServicePrinciple extends HttpAbstractStep {
    String token;
    ...
    public void setup(ImmutableMap<String, String> baggageMap, JsonNode... parentJsonObject) throws StepFailedException {
        ...
        this.token = com.freshworks.core.data.four_zero_zero.unit.dag.steps.Authentication.getAuthtoken();
    }

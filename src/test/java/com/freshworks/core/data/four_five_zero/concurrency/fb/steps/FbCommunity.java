package com.freshworks.core.data.four_five_zero.concurrency.fb.steps;
...
public class FbCommunity extends HttpAbstractStep {
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.core.data.four_five_zero.concurrency.fb.beans.FbCommunity.class);

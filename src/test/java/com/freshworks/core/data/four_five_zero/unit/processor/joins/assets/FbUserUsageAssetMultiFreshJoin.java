...
// import com.freshworks.core.data.four_five_zero.unit.processor.joins.beans.FbGroupBean;
...
// @FreshJoin(rightClass = FbUsageBean.class, uniqueJoinName = "usage_user_left_join", join_type = JOIN_TYPE.LEFT_JOIN,
//     onFieldList = {
//         @FreshJoin.OnField(rightClassFieldName = "userId", leftClass = FbGroupBean.class , leftClassFieldName = "id")
//     }
// )

// public class FbUserUsageAssetMultiFreshJoin extends AbstractAsset{
...
//     public void setFromGroupBean(FbGroupBean fbGroupBean){

//         this.firstName = fbGroupBean.getFirstName();
//         this.lastName = fbGroupBean.getLastName();
//     }

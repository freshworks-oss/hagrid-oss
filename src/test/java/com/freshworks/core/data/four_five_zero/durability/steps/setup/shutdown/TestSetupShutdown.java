package com.freshworks.core.data.four_zero_zero.durability.steps.setup.shutdown;
...
public class TestSetupShutdown extends HttpAbstractStep {
    ...
    public void setup(ImmutableMap<String, String> baggageMap, JsonNode... parentJsonObject) throws StepFailedException {
        ...
        try{
            DagTraversalService dagTraversalService = syncServiceContainer.getBean(DagTraversalService.class);
            dagTraversalService.interruptSync();
            analyticsService.infoEvent("HAGRID_DURABILITY_EVENT", "step", this.getClass().getName(), "method", "setup");

package com.freshworks.core.data.four_zero_zero.integration.fb.steps;
...
public class FbCommunity extends HttpAbstractStep {
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.core.data.four_zero_zero.integration.fb.beans.FbCommunity.class);

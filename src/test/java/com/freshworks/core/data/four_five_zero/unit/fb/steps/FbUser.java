package com.freshworks.core.data.four_zero_zero.unit.fb.steps;
...
@Slf4j
@FreshHierarchy(parentClass = ParentStep.class, rateLimit = 800, duration = 100)
@Component
@Scope("prototype")
...
public class FbUser extends HttpAbstractStep {
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) throws Exception {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.core.data.four_zero_zero.unit.fb.beans.FbUser.class);

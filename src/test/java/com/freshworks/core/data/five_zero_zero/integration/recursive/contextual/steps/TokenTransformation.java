...
import com.freshworks.core.data.five_zero_zero.integration.recursive.contextual.beans.PublishedBean;
import com.freshworks.core.data.five_zero_zero.integration.recursive.contextual.beans.TransformedBean;
...
public class TokenTransformation extends NonHttpAbstractStep {
    ...
    public RequestResponseContainer executeNonHttp(RequestResponseContainer requestResponseContainer, JsonNode... parentJsonObject){
        ...
        String token = jsonNode.get("token").textValue() + "_transformed";
    ...
    public StepDataBeanMapping parseSyncResponseNonHttp(RequestResponseContainer requestResponseContainer, JsonNode... parentJsonObject) {
        ...
        stepDataBeanMapping.setBeanClass(TransformedBean.class);

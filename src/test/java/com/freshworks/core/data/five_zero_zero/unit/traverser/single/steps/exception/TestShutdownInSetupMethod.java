package com.freshworks.core.data.five_zero_zero.unit.traverser.single.steps.exception;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.freshworks.core.CustomRegExConditionComparator;
import com.freshworks.core.data.five_zero_zero.unit.dag.steps.Authentication;
import com.freshworks.core.data.five_zero_zero.unit.traverser.single.beans.Application;
...
public class TestShutdownInSetupMethod extends HttpAbstractStep {
    ...
    public TestShutdownInSetupMethod(SyncServiceContainer syncServiceContainer) {
        super();
...
//            analyticsService.warnEvent("SYNC_SHUTDOWN", "_message", e.getMessage());
        }

        finally {
//            analyticsService.warnEvent("SYNC_SHUTDOWN", "_message", "Calling from finally");
        }
    }

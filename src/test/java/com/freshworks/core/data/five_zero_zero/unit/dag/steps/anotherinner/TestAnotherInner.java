package com.freshworks.core.data.five_zero_zero.unit.dag.steps.anotherinner;
...
@Component("unit_dag_step_TestAnotherInner")
@Scope("prototype")
@Conditional(CustomRegExConditionComparator.class)
public class TestAnotherInner extends HttpAbstractStep {

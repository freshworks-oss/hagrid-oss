package com.freshworks.core.data.five_zero_zero.unit.dag.steps.inner;
...
@Component("unit_dag_step_TestInnerStep")
@Scope("prototype")
@Conditional(CustomRegExConditionComparator.class)
public class TestInnerStep extends HttpAbstractStep {

package com.freshworks.core.data.five_zero_zero.concurrency.fb.steps;
...
public class FbComment extends HttpAbstractStep {
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.core.data.five_zero_zero.concurrency.fb.beans.FbComment.class);

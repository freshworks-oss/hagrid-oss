...
import com.freshworks.core.data.five_zero_zero.integration.recursive.contextual.beans.RoutedToken;
...
@Slf4j
@FreshHierarchy(parentClass = {TokenGenerator.class, TokenAddContext.class}, rateLimit = 800, duration = 1)
@Component
@Scope("prototype")

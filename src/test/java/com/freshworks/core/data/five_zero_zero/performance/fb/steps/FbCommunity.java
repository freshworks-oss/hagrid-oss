package com.freshworks.core.data.five_zero_zero.performance.fb.steps;
...
import com.freshworks.core.data.five_zero_zero.performance.fb.beans.*;
...
//            Thread.sleep(waitBetweenPaginationInMs);
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.core.data.five_zero_zero.performance.fb.beans.FbCommunity.class);

package com.freshworks.core.data.five_zero_zero.unit.dag.steps.inner.innermost;

import com.fasterxml.jackson.databind.JsonNode;
import com.freshworks.core.CustomRegExConditionComparator;
import com.freshworks.core.data.five_zero_zero.unit.dag.steps.inner.TestInnerStep;
...
@Slf4j
@FreshHierarchy(parentClass = TestInnerStep.class, rateLimit = 20, duration = 100)
@Component("unit_dag_step_TestInnerMost")
@Scope("prototype")
@Conditional(CustomRegExConditionComparator.class)
public class TestInnerMost extends HttpAbstractStep {

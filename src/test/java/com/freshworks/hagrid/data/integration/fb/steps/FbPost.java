package com.freshworks.hagrid.data.integration.fb.steps;
...
@Component("recursive_contextual_step_fbpost")
@Scope("prototype")
@Profile("integration")
public class FbPost extends HttpAbstractStep {
    ...
    public StepDataBeanMapping parseSyncResponse(HttpRequestResponse httpRequestResponse, JsonNode... parentJsonObject) {
        ...
        try{
            ...
            stepDataBeanMapping.setBeanClass(com.freshworks.hagrid.data.integration.fb.beans.FbPost.class);

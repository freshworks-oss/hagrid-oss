...
import com.freshworks.hagrid.data.integration.recursive.contextual.beans.FilteredBean;
import com.freshworks.hagrid.data.integration.recursive.contextual.beans.GeneratedToken;
...
@Scope("prototype")
@Profile("integration")
public class TokenAddContext extends NonHttpAbstractStep {
    ...
    public RequestResponseContainer executeNonHttp(RequestResponseContainer requestResponseContainer, JsonNode... parentJsonObject){
        ...
        objectNode.put("token", jsonNode.get("token").asText());

        Faker faker = new Faker();
        objectNode.put("context", faker.letterify("context_???????"));

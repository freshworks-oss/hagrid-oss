package com.freshworks.hagrid.integration.traverser.test;

import com.freshworks.hagrid.data.integration.fb.steps.FbComment;
import com.freshworks.hagrid.data.integration.fb.steps.FbCommunity;
import com.freshworks.hagrid.data.integration.fb.steps.FbPost;
import com.freshworks.hagrid.data.integration.fb.steps.FbUser;
import com.freshworks.hagrid.data.integration.recursive.contextual.steps.TokenGenerator;
import com.freshworks.hagrid.data.integration.recursive.contextual.steps.TokenPublisher;
import com.freshworks.hagrid.data.integration.recursive.contextual.steps.TokenRoute;
import com.freshworks.hagrid.data.integration.recursive.contextual.steps.TokenTransformation;
import com.freshworks.hagrid.data.integration.recursive.json.steps.JsonGenerator;
import com.freshworks.hagrid.data.integration.recursive.json.steps.JsonTraverser;
...
//        syncServiceContainer.add(httpClientService);
        ...
        DagNode rootNode = dagService.dagStaticStepScanner(namespace.getNamespace(), traverseConfigService, infraService);
